 ...
 */
package pe.edu.uni.Practica02.view;

import javax.swing.JOptionPane;
import pe.edu.uni.Practica02.Service.Practica02Service;
import pe.edu.uni.Practica02.Service.comunes;

/**
 *
 * @author BLENI
 */
public class Practica02View extends javax.swing.JFrame {

    /**
     * Creates new form Practica02View
     */
    ...
    private void initComponents() {
        ...
        txtInteres.setHorizontalAlignment(javax.swing.JTextField.CENTER);
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(txtInteres, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel4.setText("Importe Acumulado:");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtAcumulado, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(83, 83, 83))
        );
    ...
    private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Ingrese el capital");
            txtCapital.requestFocus();
        }
        else if(txtInteres.getText().equals("") )
        {
            JOptionPane.showMessageDialog(null, "Ingrese el Interés");
            txtInteres.requestFocus();
        }
        else if(txtPeriodo.getText().equals("") )
        {
        ...
        {
            if(comunes.isDecimal(txtCapital.getText())==false)
            {
                JOptionPane.showMessageDialog(null,"Ingrese datos validos");
                txtCapital.setText("");
                txtCapital.requestFocus();
            }
            else if(comunes.isDecimal(txtInteres.getText())==false)    
            {
                JOptionPane.showMessageDialog(null,"Ingrese datos validos");
                txtInteres.setText("");
                txtInteres.requestFocus();
            }
            else if(comunes.isNumeric(txtPeriodo.getText())==false)    
            {
                JOptionPane.showMessageDialog(null,"Ingrese datos validos");
                txtPeriodo.setText("");
                txtPeriodo.requestFocus();
    ...
    {
        double capital,importeAcumulado,interes;
        int periodos;
        ...
        txtAcumulado.setText("S/. "+importeAcumulado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Practica02View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Practica02View().setVisible(true);
            }
        });
    }
